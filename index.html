...
<body background="images/bg.jpg">
    ...
    <table border="1" align="center" cellpadding="10"> <tr>
        ...
        <center><cavas id="canvas" height="120" width="120" ></cavas></center>
        <font size="5">
            <ul>
                <li><a herf="#">Сайт будіівельної компанії</a></li>
                <li><a herf="#">Сайт ТМ"Новошкола"</a></li>
                <li><a herf="#">Редизайн сайту classno.com.ua</a></li>
                <li><a herf="#">Розробка CMS для Metro cash&Carry</a></li>
                <li><a herf="#">Сайт-візитка дизайнера інтерфейсів</a></li>
                <p align="right"><a href="#">інші...</a></p>
            </ul>
        </font>
        <hr>
        <H1 align="center"><font color="green">Реєстрація</font></H1>
        <form action="forma.php" method="post" onsubit="return send();">
                <TABLE aling="center" bgcolor="#ccc">
                    <TR>
                        <TR><font color="green">Прізвище</font>: </TR>
                        <TR><input type="text" size="10" maxlength="20" name="name2"></TR>
                    </TR>
                    <TR>
                        <TR><font color="green">Ім'я</font>: </TR>
                        <TR><input type="text" size="10" maxlength="20" name="name1"></TR>
                    </TR>
                    <TR>
                        <TR><font color="green">E-MAil</font>: </TR>
                        <TR><input type="text" size="10" maxlength="20" name="email"></TR>
                    </TR>
                    <TR>
                        <TR><font color="green">Пароль</font>: </TR>
                        <TR><input type="text" size="10" maxlength="20" name="password"></TR>
                    </TR>
                </TABLE>
                <p aling="center">
        ...
        <hr>
         ...
         <td width="70%">
            ...
            <p>Дизайн сайту від веб-студії Web-DECO
         
            <p><img src="images/penzli.jpg" height="140" alige="left" hspace="15" vspace="5">  При створенні сайту його зовнішній вигляд, з нашої точки зору, має бути гармонійним і збалансованим. Дизайн сайту повинен мати певну оригінальність, щоб він легко запам'ятовувався. З другого боку, на сайті мають бути присутні зручність візуального сприйняття і інтуітивна зрозумілість інтерфейсів. Саме тому ми пропонуємо виключно індивідуальний підхід до створення дизайну сайту. При проектуванні кольорових рішень, візуальних елементів сайту ми обов'язково врахуємо специфіку діяльності клієнта і його особисті побажання.</p>
         
            <p>Розробка сайту в нашій веб-студіїgit
         
             <p>Ми будемо раді стати Вам у нагоді і створити веб-сайт, якісний і привабливий для відвідувача. Вебстудія Web-DECO надає цілий комплекс послуг з проектування сайтів, дизайну сайтів і розробки сайтів.</p>
            <p><img src="images/html.jpg" height="140" alige="left" hspace="15" vspace="5">Основа для ефективного виконання сайтом покладених на нього задач, як правило, закладається ще в період розробки сайту. Ми ретельно ставимось до питань швидкодії і економії ресурсів при роботі сайту. В той же час, важливе значення мають його надійність, зручність керування сайтом, можливість оновлення і нарощення функціональності сайту. Тому ми розробили власну систему керування контентом сайту (CMS), яка дозволяє зробити процес управління створеним сайтом максимально зручним і приємним.</p>
